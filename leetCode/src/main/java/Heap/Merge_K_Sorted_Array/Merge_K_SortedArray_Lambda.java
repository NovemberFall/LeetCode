package Heap.Merge_K_Sorted_Array;
 ...
 *  Space: O(k) - heap
 */
class Merge_K_SortedArray_Lambda {
    static class Entry {
        // row
        int x;
        // column
    ...
    public int[] merge(int[][] arrayOfArrays) {
        ...
        PriorityQueue<Entry> minHeap = new PriorityQueue<>(10,
                (Entry a, Entry b) -> (a.val - b.val));
        int length = 0;
    ...
    public static void main(String[] args) {
        ...
        Merge_K_SortedArray_Lambda mksal = new Merge_K_SortedArray_Lambda();
        int[] res = mksal.merge(arrayOfArrays);
